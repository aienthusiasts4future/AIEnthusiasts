...
export function DetailedUseCaseCard({
  ...
  return (
    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-0">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            <span className="text-4xl">{beforeIcon}</span>
            <div>
              <h4 className="text-xl font-bold text-white">{beforeTitle}</h4>
              <span className="text-sm" style={{ color: '#ef4444' }}>Manual Process</span>
            </div>
          </div>
          ...
          <ul className="space-y-3 mb-6">
            {beforeItems.map((item, index) => (
              <li key={index} className="flex gap-2 text-text-light text-sm">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            <span className="text-4xl">{afterIcon}</span>
            <div>
              <h4 className="text-xl font-bold text-white">{afterTitle}</h4>
      ...
      >
        <h5 className="text-lg font-bold text-white mb-6 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          {metrics.map((metric, index) => (
            ...
            >
              ...
              <div className="text-xs text-text-light mb-1">{metric.label}</div>
              <div className="text-lg font-bold text-white mb-1">{metric.value}</div>
              <div className="text-xs text-text-light/70">{metric.comparison}</div>
            </div>
          ))}
        </div>
